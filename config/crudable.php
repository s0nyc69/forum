...
return [
    ...
    */
    'bindings' => [
        [
            'contract' => \App\Contracts\PostContract::class,
            'target' => \App\Services\PostService::class
        ],
        [
            'contract' => \App\Contracts\ThreadContract::class,
            'target' => \App\Services\ThreadService::class
        ],
        [
            'contract' => \App\Contracts\ChannelContract::class,
            'target' => \App\Services\ChannelService::class
        ],
